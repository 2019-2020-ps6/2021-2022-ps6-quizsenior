const { QuizDmla, QuestionDmla } = require('../../../models')
 ...
 * This function filters among the questionsDmla to return only the question linked with the given quizId.
 * @param quizId
 */
const filterQuestionsFromQuizz = (quizId) => {
    const questions = QuestionDmla.get()
...
/**
 * getQuestionFromQuiz.
 * This function retrieves a question from a quizDmla. It will throw a not found exception if the quizId in the question is different from the one provided in parameter.
 * @param quizId
 * @param questionId
 */
const getQuestionFromQuiz = (quizId, questionId) => {
    ...
    const question = QuestionDmla.getById(questionId)
